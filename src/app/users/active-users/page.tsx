    ...
    return (
        <div>
            <header style={{ marginBottom: '40px' }}>
                <h1 style={{ fontSize: '2rem', marginBottom: '8px' }}>Active Users</h1>
                <p style={{ color: 'var(--text-muted)' }}>Real-time list of users with active directory Member status.</p>
            </header>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    ...
                    <tbody>
                        {loading ? (
                            ...
                            <tr><td colSpan={3} style={{ padding: '40px', textAlign: 'center', color: 'var(--text-muted)' }}>No active users match filters.</td></tr>
